    ...
    const handleVerification = async () => {
        if (limit > 0) {
            if (parseInt(newCode) !== parseInt(currentCode)) {
                ...
                try {
                    const res: any = await authenticationAPI.HandleAuthentication(api, data, 'post');
            ...
            setErrorMessage(
                'Time out verification code , please recent new code!!!',
            );
        }
    };
    ...
    return (
        <ContainerComponent back isImageBackground isScroll>
            <SectionComponent>
                ...
                <TextComponent text={`We’ve send you the verification code on ${email.replace(
                    /.{1,5}/,
